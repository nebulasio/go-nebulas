...
func TestBlockChain_FindCommonAncestorWithTail(t *testing.T) {
	...
	*/
	...
	assert.Nil(t, err)
	block111.SetConsensusState(consensusState)
	block111.Seal()
	...
	assert.Nil(t, err)
	block1111.SetConsensusState(consensusState)
	block1111.Seal()
	...
	assert.Nil(t, err)
	block11111.SetConsensusState(consensusState)
	block11111.Seal()
