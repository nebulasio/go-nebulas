...
func NewGenesisBlock(conf *corepb.Genesis, chain *BlockChain) (*Block, error) {
	...
	declaration := fmt.Sprintf(
		"%s\n\n%s\n\n%s\n\n%s\n\n%s\n\n%s\n\n\n\n%s\n\n%s\n\n%s\n\n%s\n\n%s\n\n%s",
		"Nebulas Genesis Block Manifesto",
		"Yes! We Believe",
		...
		"The blockchain community embodies the values of openness, collaboration, and transparency. An ecosystem created by blockchain believers is a voluntary association anchored by aligned incentives. We believe blockchain represents the social contract of the future, and that this will lead to a civilization where cooperation, inclusion, and the interests of society converge. ",
		"We believe blockchain will bring more freedom, equality and purpose to the world. We believe blockchain is a digital organism and economic system. Revolutionary ideas and technology to fulfill its destiny. This means challenges, opportunities, and also hope. Don't ask what blockchain can do for you. Ask what you can do for blockchain.",
		...
		"我们始终坚信，区块链技术会帮助人们抵达更为自由、平等、美好的生活。区块链作为一个全新的生命体和经济体，意味着新的思想和技术，也意味着新的挑战、机遇和希望。面对未来巨大可能性的感召，不要问区块链能为你做什么，要问你能为区块链做什么。",
		"星云正是为此而生。",
	)
