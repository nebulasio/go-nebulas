...
func (nvm *mockNvm) StartNebulasVM(enginePath string, listenAddr string) (int, error){
  return 0, nil
}
func (nvm *mockNvm) StopNebulasVM(enginePid int) error {
  return nil
}
func (nvm *mockNvm) CheckV8ServerRunning(enginePid int) error {
	return nil
}
func (nvm *mockNvm) GetNVMListenAddr() string { return "" }
...
func (nvm *mockEngine) DeployAndInit(config *NVMConfig) (string, error) {
	return "", nil
}
func (nvm *mockEngine) Call(config *NVMConfig) (string, error) {
	return "", nil
}
func (nvm *mockEngine) ExecutionInstructions() uint64 {
	return uint64(100)
}
func (nvm *mockEngine) RunScriptSource(config *NVMConfig) (string, error){
  return "", nil
}
