...
entry_point_nr_v2(neb::compatible_uint64_t start_block,
                  neb::compatible_uint64_t end_block);

neb::rt::dip::dip_ret_type entry_point_dip_v2(neb::compatible_uint64_t height) {
  ...
  auto nr_ret = entry_point_nr_v2(start_block, end_block);
