...
namespace neb {
namespace fs {
class auth_ir_list : public internal::ir_item_list_base<auth_params_storage_t> {
public:
  typedef auth_params_storage_t::item_type item_type;
  auth_ir_list(rocksdb_storage *storage);
