...
assertEqual(test1, [0], 1, 3);
assertEqual(test1, [2], 4, 5 * 2 + 3);
assertEqual(test1, [10], 1024, 5 * 10 + 3);
assertEqual(test1, [11], 1024, 5 * 10 + 3);
...
assertEqual(test2, [0], 2, 5);
assertEqual(test2, [2], 4, 5 * 2);
assertEqual(test2, [10], 1024, 5 * 10);
assertEqual(test2, [11], 1024, 5 * 10);
...
assertEqual(test3, [1], 1024, 21);
assertEqual(test3, [2], 1024, 21);
assertEqual(test3, [10], 1024, 21);
