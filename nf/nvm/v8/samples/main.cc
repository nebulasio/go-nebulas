...
int main(int argc, const char *argv[]) {
  ...
  InitializeBlockchain(GetTxByHash, GetAccountState, Transfer, VerifyAddress, GetPreBlockHash, GetPreBlockSeed, GetLatestNebulasRank, GetLatestNebulasRankSummary);
