...
char *GetPreBlockHash(void *handler, unsigned long long distance, size_t *counterVal);
char *GetPreBlockSeed(void *handler, unsigned long long distance, size_t *counterVal);
