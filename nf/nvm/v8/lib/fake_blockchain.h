...
int GetPreBlockHash(void *handler, unsigned long long distance, size_t *counterVal, char **result, char **info);
int GetPreBlockSeed(void *handler, unsigned long long distance, size_t *counterVal, char **result, char **info);
