...
char *GetContractSource(void *handler, const char *address, size_t *counterVal);
char *InnerContract(void *handler, const char *address, const char *funcName, const char *v, const char *args, size_t *gasCnt);
