...
type NVMConfigBundle struct {
	...
	LimitsExeInstruction            uint64   `protobuf:"varint,11,opt,name=limits_exe_instruction,json=limitsExeInstruction,proto3" json:"limits_exe_instruction,omitempty"`
	LimitsTotalMemSize              uint64   `protobuf:"varint,12,opt,name=limits_total_mem_size,json=limitsTotalMemSize,proto3" json:"limits_total_mem_size,omitempty"`
	ExecutionTimeout                uint64   `protobuf:"varint,13,opt,name=execution_timeout,json=executionTimeout,proto3" json:"execution_timeout,omitempty"`
	TimeoutGasLimitCost             uint64   `protobuf:"varint,14,opt,name=timeout_gas_limit_cost,json=timeoutGasLimitCost,proto3" json:"timeout_gas_limit_cost,omitempty"`
	MaxLimitsOfExecutionInstruction uint64   `protobuf:"varint,15,opt,name=max_limits_of_execution_instruction,json=maxLimitsOfExecutionInstruction,proto3" json:"max_limits_of_execution_instruction,omitempty"`
	DefaultLimitsOfTotalMemSize     uint64   `protobuf:"varint,16,opt,name=default_limits_of_total_mem_size,json=defaultLimitsOfTotalMemSize,proto3" json:"default_limits_of_total_mem_size,omitempty"`
...
var fileDescriptor_83a3db176960b780 = []byte{
	...
	,
}
