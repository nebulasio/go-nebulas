...
type APIServiceClient interface {
	...
	// Call a contract.
	Call(ctx context.Context, in *SendTransactionRequest, opts ...grpc.CallOption) (*SendTransactionResponse, error)
...
func (c *aPIServiceClient) Call(ctx context.Context, in *SendTransactionRequest, opts ...grpc.CallOption) (*SendTransactionResponse, error) {
	out := new(SendTransactionResponse)
...
type APIServiceServer interface {
	...
	// Call a contract.
	Call(context.Context, *SendTransactionRequest) (*SendTransactionResponse, error)
	// Submit the signed transaction.
...
func _APIService_Call_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).Call(ctx, req.(*SendTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
