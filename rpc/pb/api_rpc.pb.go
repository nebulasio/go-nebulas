...
func (*GetNebStateResponse) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{3} }
...
func (*AccountsRequest) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{4} }
...
func (*AccountsResponse) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{5} }
...
func (*GetAccountStateRequest) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{6} }
...
func (*GetAccountStateResponse) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{7} }
...
func (*SendTransactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{8} }
...
func (*CallRequest) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{9} }
...
func (*SendRawTransactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{10} }
...
func (*SendTransactionResponse) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{11} }
...
func (*GetBlockByHashRequest) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{12} }
...
func (*GetTransactionByHashRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorApiRpc, []int{13}
}
...
func (*BlockDumpRequest) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{14} }
...
func (*BlockDumpResponse) Descriptor() ([]byte, []int) { return fileDescriptorApiRpc, []int{15} }
...
func (*TransactionReceiptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorApiRpc, []int{16}
}
